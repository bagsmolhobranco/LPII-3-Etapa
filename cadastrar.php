<?php
    ...
    if(isset($_POST['login'])){
        ...
        if($existe){
            ...
            $sql = "insert into usuario(login,senha,nome) values('$login','$senha_hash','$nome')";
            ...
            if($cadastrar){
                echo "
                    <script> 
                        ...
                        window.location = '/trabalhojs/aplicacao/aplicacao.html';
                    </script>
                ";
            }
            else{
                echo "
                    ...
                    <p> Clique <a href='index.php'> aqui </a> para retornar ao formulário de cadastro </p>
                ";
        ...
        echo "
            ...
            <p> Clique <a href='index.php'> aqui </a> para a acessar o formulário de cadastro </p>
        ";
    }
